...
include::index/integration-options/shop-plugins/shop-systems.adoc[leveloffset=+1]
...
include::index/integration-guides/shop-plugins/common-intro.adoc[leveloffset=+2]
include::index/integration-guides/shop-plugins/magento.adoc[leveloffset=+3]
include::index/integration-guides/shop-plugins/prestashop.adoc[leveloffset=+3]
include::index/integration-guides/shop-plugins/woocommerce.adoc[leveloffset=+3]
