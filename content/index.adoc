...
include::index/integration-guides/mobile-payment-sdk/alipay-cross-border/alipay.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/credit-card/credit-card.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/paypal/paypal.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/przelewy24/przelewy24.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/sepa-direct-debit/sepa.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/wire-transfer/wire-transfer.adoc[leveloffset=+4]
