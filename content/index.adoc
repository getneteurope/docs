...
include::index/payment-methods/alipay-qr-pay/alipay-qr-pay-main.adoc[leveloffset=+1]
include::index/payment-methods/alipay-qr-pay/rest/11-49-alipay-qr-pay-rest.adoc[leveloffset=+2]
...
include::index/payment-methods/giropay/ppv2/03-01-04-17-giropay.adoc[leveloffset=+2]
