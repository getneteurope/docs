...
include::index/payment-methods/applepay/apple-pay-main.adoc[leveloffset=+1]
include::index/payment-methods/applepay/rest/Apple Pay Integration Specifications (1).adoc[leveloffset=+2]
