...
include::index/integration-guides/mobile-payment-sdk/ios/alipay-cross-border/alipay.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/ios/credit-card/credit-card.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/ios/paypal/paypal.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/ios/przelewy24/przelewy24.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/ios/sepa-direct-debit/sepa.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk/ios/wire-transfer/wire-transfer.adoc[leveloffset=+4]
