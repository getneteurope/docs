...
include::index/integration-guides/mobile-payment-sdk/android/payment-methods/08-01-01-08-ratepay.adoc[leveloffset=+4]
...
include::index/integration-guides/mobile-payment-sdk/ios/payment-methods/08-01-01-08-ratepay.adoc[leveloffset=+4]
