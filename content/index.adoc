...
include::index/integration-options/shop-plugins/05-00-shop-systems.adoc[leveloffset=+1]
...
include::index/integration-guides/shop-plugins/05-00-common-intro.adoc[leveloffset=+2]
include::index/integration-guides/shop-plugins/05-00-03-magento.adoc[leveloffset=+3]
include::index/integration-guides/shop-plugins/05-00-01-prestashop.adoc[leveloffset=+3]
include::index/integration-guides/shop-plugins/05-00-02-woocommerce.adoc[leveloffset=+3]
