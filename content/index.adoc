...
include::index/payment-methods/bizum/payment-bizum-main.adoc[leveloffset=+1]
include::index/payment-methods/bizum/rest/payment-bizum.adoc[leveloffset=+2]
include::index/payment-methods/bizum/ppv2/payment-bizum.adoc[leveloffset=+2]
