...
include::index/integration-guides/mobile-payment-sdk-ios/08-01-01-00-credit-card.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk-ios/08-01-01-01-paypal.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk-ios/08-01-01-02-przelewy24.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk-ios/08-01-01-03-sepa.adoc[leveloffset=+4]
include::index/integration-guides/mobile-payment-sdk-ios/08-01-01-04-wire-transfer.adoc[leveloffset=+4]
