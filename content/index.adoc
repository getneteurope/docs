...
include::index/integration-options/03-00-shop-plugin.adoc[leveloffset=+1]
...
include::index/integration-guides/03-00-shop-plugin.adoc[leveloffset=+2]
include::index/integration-guides/03-00-prestaxxx.adoc[leveloffset=+3]
include::index/integration-guides/03-00-wocommerce.adoc[leveloffset=+3]
include::index/integration-guides/03-00-zzzzz.adoc[leveloffset=+3]
