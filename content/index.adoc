...
include::index/integration-guides/shop-plugins/05-00-00-01-common-intro.adoc[leveloffset=+2]
include::index/integration-guides/shop-plugins/05-00-01-01-prestashop.adoc[leveloffset=+4]
include::index/integration-guides/shop-plugins/05-00-02-01-woocommerce.adoc[leveloffset=+4]
include::index/integration-guides/shop-plugins/05-00-03-01-magento.adoc[leveloffset=+4]
