...
include::index/payment-methods/mbway/mbway-main.adoc[leveloffset=+1]
include::index/payment-methods/mbway/rest/payment-mbway-rest.adoc[leveloffset=+2]
include::index/payment-methods/mbway/ppv2/payment-mbway.adoc[leveloffset=+2]
