...
When using a credit card for a <<CreditCard_PaymentFeatures_LoyaltyPrograms, loyalty program>>, At least one of the following must be present: ``consumer-id``, ``email`` or ``phone``.
