...
.2020-07-14
- <<CreditCard_3DS2_PSD2_Grandfathering, 3D Secure 2 Recurring Merchant Initiated (MIT) Transactions>> - Added information on exemption for certain recurring MIT transactions.
