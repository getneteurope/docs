...
[cols="1h,5"]
|===
|Countries |Austria, Denmark, Finland, Germany, Netherlands, Norway, Sweden, Switzerland, UK, Australia
|Currencies | CHF, DKK, EUR, GBP, NOK, SEK, AUD
|===
...
|``klarna-paylater``
|Austria
|``klarna-paylater``, ``klarna-slice-it`` (klarna-finance)
|Denmark
|``klarna-paylater``, ``klarna-slice-it``
|Finland
|``klarna-paylater``, ``klarna-slice-it``
|Germany
|``klarna-debit``, ``klarna-transfer``, ``klarna-paylater``, ``klarna-slice-it``
|Netherlands
|``klarna-debit``, ``klarna-paylater``
|Norway
|``klarna-paylater``, ``klarna-slice-it``
|Sweden
|``klarna-debit``, ``klarna-paylater``, ``klarna-slice-it``
|Switzerland
|``klarna-transfer``
|UK
|``klarna-paylater``, ``klarna-slice-it``
...
// ``klarna-debit` = ``klarna-pay-now`` ?????
// ``klarna-transfer`` = ``klarna-pay-now`` ?????
// ``klarna-finance`` = ``klarna-slice-it`` ?????
