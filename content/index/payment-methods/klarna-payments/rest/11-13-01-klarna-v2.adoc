...
| City | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[] | image:icons/icon-positive.png[]
| Region | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] | image:icons/icon-negative.png[] ||
