...
| Email a| image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| Gender | derived | from PNO | from PNO | derived | derived | from PNO | from PNO | derived | derived | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] 
| NIN* | image:content/icons/icon-negative.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] 
| Title | optional | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | optional | optional | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | optional | optional | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] 
| Given Name| image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| Family Name | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| Date of Birth | image:content/icons/icon-question.png[] | from PNO | from PNO | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] | from PNO | from PNO | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] | image:content/icons/icon-question.png[] 
| Street Address | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| Street Address 2 | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | optional | optional | optional 
| C/O | optional | optional | optional | optional | optional | optional | optional | optional | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] 
| Postal Code | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| City | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[]
| Region | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] | image:content/icons/icon-negative.png[] ||
| Phone | optional | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | optional | optional | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | optional | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] | image:content/icons/icon-positive.png[] 
|===
* NIN = National Identification Number

image:content/icons/icon-positive.png[]
