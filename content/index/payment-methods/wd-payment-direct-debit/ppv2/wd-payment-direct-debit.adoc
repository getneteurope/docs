:payment-method-name: Ratepay Direct Debit
...
|5289ba2d-6094-4f7d-b6c2-346d1af638eb
...
|bb3ec883-9c5b-4e70-beff-c3151b17ecf4
|===
...
|Optional
|15
|The name of the payment method used. Set this value to ``ratepay-elv`` for Ratepay Direct Debit``.
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PPv2_GuaranteedGuaranteedDirectDebit_TransactionTypeAuthorization_DecodedPaymentResponse.json[]
----
