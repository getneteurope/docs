...
image::images/11-43-guaranteed-direct-debit/guaranteed_DD_workflow.png[{payment-provider-name} Payment Guaranteed Direct Debit Workflow, width=950, align="center"]
