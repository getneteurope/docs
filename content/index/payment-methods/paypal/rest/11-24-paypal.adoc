...
[cols="30h, 70"]
|===
| URLs (Endpoints) (The transaction types debit, authorization, authorization-only, preauthorization, pending-credit, credit or order use) |``https://api-test.getneteurope.com/engine/rest/paymentmethods/``
| URLs (Endpoints) (The transaction types capture-authorization, refund-capture, void-authorization and refund-debit use)|``https://api-test.getneteurope.com/engine/rest/payments/``
| Merchant Account ID (MAID) | bb342082-9761-4481-802e-20b10d92545d
| Username | 515225-GetnetEuropeTEST
| Password | 4cHLRE-Q7YcAP
| Secret Key | 01ab26af-d5c7-46f8-b5dd-8a1516c3e85c
|===
...
Please use the list of state codes supported by https://developer.paypal.com/docs/nvp-soap-api/state-codes/[Paypal]
...
``paypal_api1.getneteurope.com`` and click _Lookup_.
+
image::images/11-24-paypal/Granting_3rdParty_AddNewTPP_getnet.jpg[Paypal 3rdparty Newaccess]
+
