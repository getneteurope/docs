...
|country |O |O |O |String |3 |Name of the shipment recipient's country. Please use the list of country codes supported by https://developer.paypal.com/api/nvp-soap/country-codes/[Paypal]
...
Please use the list of state codes supported by https://developer.paypal.com/api/nvp-soap/country-codes/[Paypal]
