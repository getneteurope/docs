...
_blik_ is a type of <<PaymentMethods_PaymentMode_OnlineBankTransfer, Online Bank Transfer>>.
...
<<blik_Samples_debit, debit samples>>
...
|<<blik_Samples_refund, refund samples>>
...
along with the _P24-Transaction-ID_. See section <<blik_BankingStatement, Banking Statement>> for details.
