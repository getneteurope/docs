...
_blik (P24)_ offers bank transfers and other payment methods for the
...
Currently, _blik_ cooperates with 165 banks.
...
image::images/03-01-04-09-blik/P24_Demoshop.PNG[P24 Demoshop]
...
along with the P24-Transaction-ID. See section <<blik_BankingStatement, Banking Statement>> for details on the P24-Transaction-ID.
...
along with the P24-Transaction-ID. See section <<blik_BankingStatement, Banking Statement>> for details
...
<<blik_refundProcessUsingtheReSTAPI, refund process for _P24_ via our REST API>>.
