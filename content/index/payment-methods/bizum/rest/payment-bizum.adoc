...
6. Merchant processes the transaction based on the notification.
...
6. Merchant receives an updated refund status from the Payment Gateway.
7. Merchant processes the updated refund status based on the notification.
...
5. Merchant receives an updated status notification from the Payment Gateway.
