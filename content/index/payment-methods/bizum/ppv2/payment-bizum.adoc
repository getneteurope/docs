...
|Optional
|36
a|The order number from the merchant. It is recommended that the order number be a maximum of 12 characters, otherwise it will be truncated. No special characters are allowed. If you are using the ``auto-sale`` transaction type, this field is mandatory.

4+|descriptor
|String
|Optional
|36
a|The description of the transaction displayed on the consumer’s statement. If you are using the ``auto-sale`` transaction type, this field is mandatory.
...
|Mandatory
|45
|IP address of the consumer’s browser. Accepted format is IPv4.
