...
image::images/diagrams/payolution_inv-b2c_auth_capt-auth.svg[payolution Invoice B2C, width=950, align="right"]
...
image::images/diagrams/payolution_inv-b2b_auth_capt-auth.svg[payolution Invoice B2B, width=950, align="right"]
...
image::images/diagrams/payolution_install_auth_capt-auth.svg[payolution Installment, width=950, align="right"]
...
image::images/diagrams/payolution_reversal_void-auth.svg[payolution Reversal, width=950, align="right"]
...
image::images/diagrams/payolution_refund_refund-capt.svg[payolution Refund, width=950, align="right"]
