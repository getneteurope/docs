...
{payment-provider-name}. You can find a corresponding XML sample for either <<API_PaymentInvoice_Samples_GuaranteedInvoice, Guaranteed Payment on Invoice>> or <<API_PaymentDirectDebit_Samples_DirectDebit, {payment-provider-name} Payment Guaranteed Direct Debit>>.
