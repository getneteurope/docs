...
| _pending-authorization_ | <<, _pending-authorization_ sample>>
| _capture-authorization_ | <<, _capture-authorization_ sample>>
| _void-authorization_ | <<, _void-authorization_ sample>>
| _refund-authorization_ | <<, _refund-authorization_ sample>>
...
[#API_LinePay_Samples_RefundAuth]
==== _refund-capture_
