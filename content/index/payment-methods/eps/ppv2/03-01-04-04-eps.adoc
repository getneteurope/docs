...
Go to the <<eps, REST API>> documentation for information on {payment-page-v1} image:images/icons/legacy.png[LEGACY, 80, 20, role="no-zoom", title="Development of this product is discontinued."] integration.
