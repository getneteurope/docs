...
| <<CC_Fields_xmlelements_cardPINenccontext, X>>
| 
...
| <<CC_Fields_xmlelements_cardRAWenccontext, X>>
| 
...
[#CC_Fields_xmlelements_cardPINenccontext]
.card-pin.encryption-context
...
[#CC_Fields_xmlelements_cardRAWenccontext]
.card-raw.encryption-context
