...
| card-data
| 
| <<CC_Fields_xmlelements_request_carddata, X>> 
...
// include::{root}/include/field-list-headers/rest_cc/request/res-loyalty-card.adoc[]
...
include::{root}/include/fields/rest_cc/request/res-loyalty-card.adoc[]
