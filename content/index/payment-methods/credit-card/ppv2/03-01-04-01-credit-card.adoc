...
(ECI Value: 05 - VISA/Diners/American Express; 02 - Mastercard)

3D authentication unsuccessful:: Either the card issuing bank is not
3D ready or the cardholder is not enrolled.
(ECI Value: 06 - VISA/Diners/American Express; 01 - Mastercard)
...
(ECI Value: 07 - VISA/Diners/American Express; 00 - Mastercard)
