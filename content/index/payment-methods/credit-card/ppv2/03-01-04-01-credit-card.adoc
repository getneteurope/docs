...
====
We recommend using {payment-page-v2} integration. If you have questions about your existing integration, consult our <<CreditCard, REST API>> integration guide.
====
