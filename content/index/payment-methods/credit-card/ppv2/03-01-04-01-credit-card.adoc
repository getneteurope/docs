...
====
{payment-page-v1} image:images/icons/legacy.png[LEGACY, 80, 20, role="no-zoom", title="Development of this product is discontinued."] is no longer supported. We recommend using {payment-page-v2} integration instead. If you have questions about your existing {payment-page-v1} integration, consult our <<CreditCard, REST API>> integration guide.
====
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/WPP_CC_JSONNVPField_JSON_StructureForCreditCardRequests.json[]
----

[%autowidth,cols="m,m,m"]
|===
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/WPP_CC_JSONNVPFieldResponseonly.json[]
----
