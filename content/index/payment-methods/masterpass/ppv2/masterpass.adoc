...
_{payment-method-name}_ is a type of <<PaymentMethods_PaymentMode_Wallet, Wallet>>.

[#PPv2_masterpass_GeneralInformation]
=== General Information

include::{root}/include/ppv2-general-information.adoc[]

Below, we provide <<PPv2_masterpass_Sample, a sample>> to which you can refer for all the {:payment-method-name:} transaction types _debit_, _authorization_ and _authorization-only_ including field lists with short descriptions.

include::{root}/include/ppv2-general-information-2.adoc[]

[#PPv2_masterpass_TestCredentials]
=== Test Credentials
...
|8bc8ed6d-81a8-43be-bd7b-75b008f89fa6

// |Username                   
// |16390-testing
// PSPDOC-359 says: Username = 70000-APITEST-AP

|Password                   
|qD2wzQ_hrc!8

|Secret Key                 
|87e1c187-363f-41d8-abab-7bae0fb03eca
|===

[#PPv2_masterpass_Countries]
...
[#PPv2_masterpass_TransactionTypes]
=== Transaction Types

// With _{payment-method-name}_ you can use the transaction types <<PPv2_masterpass_Samples_debitauth, _authorization_>> and <<PPv2_masterpass_Samples_debitauth, _debit_>>.
...
[#PPv2_masterpass_Sample_Workflow]
=== Sample Workflow
...
[#PPv2_masterpass_Samples_allTransactionTypes]
=== _debit_, _authorization_ and _authorization-only_ Sample

[#PPv2_masterpass_Samples_allTransactionTypes_Create]
...
[#PPv2_masterpass_Samples_allTransactionTypes_Redirect]
...
[#PPv2_masterpass_Samples_allTransactionTypes_Parse]
...
// |payload 
// |String 
// |This field is used for certain payment methods and occurs in the response only. Irrelevant for _{payment-method-name}_.
...
// <<paydirekt, _{payment-method-name}_ specification>>. Use the JSON structure of the _{payment-method-name}_ request below as a mapping reference.


[#PPv2_masterpass_TransactionTypes_postprocess]
...
// IMPORTANT: Check the <<paydirekt_TransactionTypes, REST API paydirekt specification>> for details on _{payment-method-name}_-specific post-processing operations.

[#PPv2_masterpass_JSONFieldReference]
