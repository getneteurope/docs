...
|order-number |O |O |Alphanumeric |64 2+|Order number of the merchant. 
...
|Alphanumeric
|64
2+|Changed order number of the merchant.
...
|Alphanumeric
|64
2+|Order number of the merchant if not provided with the authorization.
