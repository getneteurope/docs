...
- You starts with an _authorization_ of the payment by sending a
...
- Please contact {payment-provider-name} Customer Support if a pending-authorization
...
|Alphanumeric
|36
2+|Transaction ID of the parent _authorization_ or adjust-authorization
transaction.
