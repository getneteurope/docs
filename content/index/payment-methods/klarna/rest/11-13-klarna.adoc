...
.XML Klarna Invoice authorization Request (Failed)
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/klarna-invoice_authorization_request__de_DE.xml[]
----

.XML Klarna Invoice authorization Response (Failed)
[source,xml,subs=attributes+]
----
...
.XML Klarna Invoice void-authorization Request (Successful)
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/klarna-invoice_void-authorization_request_success_b9e50fc5.xml[]
----

.XML Klarna Invoice void-authorization Response(Successful)
[source,xml,subs=attributes+]
----
...
--
NOTE: Refer to the <<Klarna_Samples_authorization, "XML Klarna Invoice authorization request for DE" sample>> to test these capture-authorization samples.
--

.XML Klarna Invoice Full capture-authorization Request (Successful)
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/klarna-invoice_capture-authorization_request_success_35bdae97.xml[]
----

.XML Klarna Invoice Full capture-authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/klarna-invoice_capture-authorization_response_success_de_DE_35bdae97.xml[]
----

.XML Klarna Invoice Partial capture-authorization Request (Successful)
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/klarna-invoice_capture-authorization_request_success_b9e50fc5.xml[]
----

.XML Klarna Invoice Partial capture-authorization Response (Successful)
[source,xml,subs=attributes+]
----
