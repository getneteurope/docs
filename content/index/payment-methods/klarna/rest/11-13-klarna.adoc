...
|Alphanumeric
|36
2+|Transaction ID is the unique identifier for a transaction. {payment-provider-name} generates this ID.
...
|Alphanumeric
|15
2+|Name of the payment method: ``klarna-invoice``, ``klarna-install``
...
|{payment-provider-name} generates this ID.
