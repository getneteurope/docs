:payment-method-name: Payment in Installments

[#PPv2_PaymentInstallment]
== {payment-page-v2}

====
We recommend using {payment-page-v2} integration instead. If you have questions about your existing {payment-page-v1} integration, consult our <<API_PaymentInstallment, REST API>> integration guide.
====
