...
====
{payment-page-v1} image:images/icons/legacy.png[LEGACY, 80, 20, role="no-zoom", title="Development of this product is discontinued."] is no longer supported. We recommend using {payment-page-v2} integration instead. If you have questions about your existing {payment-page-v1} integration, consult our <<e-przelewy, REST API>> integration guide.
====

[#PPv2_P24_General]
=== General Information

This is a reference page for _e-przelewy_. Here you find all the information
...
_e-przelewy (P24)_ offers bank transfers and other payment methods for the
...
Currently, _e-przelewy_ cooperates with 165 banks.
...
| Merchant Account ID (MAID) | 39525cf9-fe90-4f99-9ce2-42815754d7c1
| Username                   | 515225-GetnetEuropeTEST
| Password                   | 4cHLRE-Q7YcAP
| Secret Key (used for response verification) | 6951db91-063a-4f28-b88e-02bde3ae555e
|===
...
along with the P24-Transaction-ID. See section <<e-przelewy_BankingStatement, Banking Statement>> for details on the P24-Transaction-ID.
...
along with the P24-Transaction-ID. See section <<e-przelewy_BankingStatement, Banking Statement>> for details
...
<<e-przelewy_refundProcessUsingtheReSTAPI, refund process for _P24_ via our REST API>>.
