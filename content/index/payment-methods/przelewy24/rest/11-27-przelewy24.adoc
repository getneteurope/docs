...
_e-przelewy_ is a type of <<PaymentMethods_PaymentMode_OnlineBankTransfer, Online Bank Transfer>>.

[#e-przelewy_PaymentModeCountriesandCurrencies]
...
[#e-przelewy_CommunicationFormats]
...
<<e-przelewy_Samples_debit, debit samples>>
...
|<<e-przelewy_Samples_refund, refund samples>>
...
h| Merchant Account ID 3+| 39525cf9-fe90-4f99-9ce2-42815754d7c1
h| Username            3+| 515225-GetnetEuropeTEST
h| Password            3+| 4cHLRE-Q7YcAP
h| Secret Key          3+| 6951db91-063a-4f28-b88e-02bde3ae555e
|===

[#e-przelewy_Workflow]
=== Workflow

[#e-przelewy_debitTransaction]
==== _debit_ Transaction

[#e-przelewy_debitPrerequisites]
===== Prerequisites
...
[#e-przelewy_debitProcessUsingtheReSTAPI]
===== Payment Process Using the ReST API

image::images/diagrams/e-przelewy_debit_rest.svg[Payment Process Using ReST API]
...
[#e-przelewy_debitProcessUsingthePaymentPage]
===== Payment Process Using the Payment Page

.Payment Process Using Payment Page
image::images/diagrams/e-przelewy_debit_pp.svg[Payment Process Using Payment Page]
...
[#e-przelewy_refundPrerequisites]
===== Prerequisites
...
[#e-przelewy_refundProcessUsingtheReSTAPI]
===== _refund_ Process Using the ReST API

.refund Process Using the ReST API
image::images/diagrams/e-przelewy_refund_rest.svg[refund Process Using the ReST API]
...
provided in the field ``descriptor`` of the <<e-przelewy_Samples_debit, debit request>>.

The structure of the _P24-Transaction-ID_ is
``P24-YXX-XXX-XXX``. _The _P24-Transaction-ID__ is also displayed in
the _{enterprise-portal-name}_ as _Provider Transaction-ID_.
...
along with the _P24-Transaction-ID_. See section <<e-przelewy_BankingStatement, Banking Statement>> for details.
