...
bank account to the Getnet's Santander Bank account.
...
h|Merchant Account ID (MAID) 2+| 7efcbcb5-c824-41fe-802e-617d7279ccd3
h|Username 2+|Getnet _POI
h|Password 2+|To be determined
h|Secret Key 2+|	d7c8868b-5d1d-4a3f-ab07-12ef0555c1f3
|===
...
If an amount is provided in the _credits_ request, this value will be
...
for a transaction. It is generated by the system.
...
|provider-transaction-reference-id |  |M |String |10 |System generates this
...
for a transaction. It is generated by Getnet.
