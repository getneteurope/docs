...
You can download Standard EPA – Merchant Specification document here: link:resources/17-08-standard-epa–merchant-specification/Standard EPA merchant specification_1.4.2 (Getnet).pdf[Standard EPA merchant specification_1.4.2 (Getnet).pdf]


[source,pdf,subs=attributes+]
----
include::{root}/resources/17-08-standard-epa–merchant-specification/Standard EPA merchant specification_1.4.2 (Getnet).pdf[]
----
