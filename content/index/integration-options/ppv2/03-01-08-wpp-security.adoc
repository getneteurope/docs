...
All Payment Page integrations share a common backend-to-backend JSON
...
h|Payment Processing with _Payment Page_ image:images/icons/legacy.png[LEGACY, 80, 20, role="no-zoom", title="Development of this product is discontinued."] in Seamless Mode
a|.  Create a payment session (initial request).
...
NOTE: For more information regarding Payment Page integration-specific payment
...
<<PPv2_Seamless_Integration, Integrating Payment Page in Seamless Mode>>.
