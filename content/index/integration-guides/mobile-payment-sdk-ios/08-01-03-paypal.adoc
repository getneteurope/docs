...
[#MobilePaymentSDK_2_iOS_PayPal_basic_setup]
==== Basic Setup

[#MobilePaymentSDK_2_iOS_PayPal_basic_setup_cocoapods]
===== Cocoapods
...
[#MobilePaymentSDK_2_iOS_PayPal_basic_payment]
==== PayPal Payment
...
[#MobilePaymentSDK_2_iOS_PayPal_recurring_payment]
