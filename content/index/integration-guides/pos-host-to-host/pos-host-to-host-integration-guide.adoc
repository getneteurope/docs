...
| _reversal-authorization_ | Reverses an _authorization_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalauthorization, _reversal-authorization_ samples>>
| _reversal-capture-authorization_ | Reverses a _capture-authorization_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalcaptureauthorization, _reversal-capture-authorization_ samples>>
| _reversal-credit_ | Reverses a _credit_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalcredit, _reversal-credit_ samples>>
| _reversal-purchase_ | Reverses a _purchase_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalpurchase, _reversal-purchase_ samples>>
| _reversal-refund-capture_ | Reverses a _refund-capture_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalrefundcapture, _reversal-refund-capture_ samples>>
| _reversal-refund-purchase_ | Reverses a _refund-purchase_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalrefundpurchase, _reversal-refund-purchase_ samples>>
| _reversal-void-authorization_ | Reverses a _void-authorization_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalvoidauthorization, _reversal-void-authorization_ samples>>
| _reversal-void-credit_ | Reverses an _void-credit_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalvoidcredit, _reversal-void-credit_ samples>>
| _reversal-void-purchase_ | Reverses an _authorization_ transaction. | <<POSHostToHostIntegrationGuide_Samples_reversalvoidpurchase, _reversal-void-purchase_ samples>>
...
| _void-refund-capture_ | Voids a _refund-capture_ transaction. | <<POSHostToHostIntegrationGuide_Samples_voidrefundcapture, _void-refund-capture_ samples>>
| _void-refund-purchase_ | Voids a _refund-purchase_ transaction. | <<POSHostToHostIntegrationGuide_Samples_voidrefundpurchase, _void-refund-purchase_ samples>>
|===
