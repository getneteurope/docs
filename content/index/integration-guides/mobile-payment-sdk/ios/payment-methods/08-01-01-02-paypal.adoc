...
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/paypal.png[Paypal Screen, align=center, width=240, height=420]
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/paypal-customized.png[Paypal Screen, align=center, width=240, height=420]
|
|===

[#MobilePaymentSDK_iOS_Paypal_Visualisaton_CustomizingVisuals]
=== Customizing Visuals
---
...
[#MobilePaymentSDK_iOS_Paypal_Visualisaton_CustomizingVisuals_Example]
==== Customization Example
---

This is a code example for a basic Paypal screen customization:
...
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/paypal-appearance.png[Paypal Screen Appearance, align=center, width=240, height=420]
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/paypal-customized-appearance.png[Paypal Screen Appearance, align=center, width=240, height=420]
|
|===
