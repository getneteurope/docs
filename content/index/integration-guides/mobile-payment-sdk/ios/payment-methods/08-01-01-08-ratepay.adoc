...
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/ratepay-invoice.png[RatePay Screen, align=center, width=240, height=420]
| image::images/07-01-02-integrating-mpsdk-on-ios/iOS/ratepay-elv.png[RatePay Screen, align=center, width=240, height=420]
|
|===
