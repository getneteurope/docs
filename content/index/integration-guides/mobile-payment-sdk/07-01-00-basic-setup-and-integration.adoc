...
[#MobilePaymentSDK_BasicSetup_Security_Debugging_prevention]
...
image:images/07-01-basic-setup-and-integraton/user-defined-settings.png[User-Defined Settings] 
...
image:images/07-01-basic-setup-and-integraton/target-properties.png[Custom iOS Target Properties] 
