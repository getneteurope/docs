...
Since 14 September 2019, the PSD 2 Regulatory Technical Standard has required SCA for 3D Secure 2 payment processes. This also applies to recurring payments (see 
