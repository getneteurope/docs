...
|``\https://{rest-api-test-merchant-endpoint}{merchant-account-id}/payments/{transaction-id}``
|===
...
``\https://{rest-api-test-merchant-endpoint}ba261be8-af94-11df-ab7800163e5eafd7/payments/048b27e0-9c31-4cab-9eab-3b72b1b4d498``
...
|===
|URL
|``\https://{rest-api-test-merchant-endpoint}\{merchant-account-id}/payments/search?payment.request-id=\{request-id}``
|===
...
``\https://{rest-api-test-merchant-endpoint}ba261be8-af94-11df-ab78-00163e5eafd7/payments/search?payment.request-id=048b27e0-9c31-4cab-9eab-3b72b1b4d498``
